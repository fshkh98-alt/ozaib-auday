    ...
    <form action={action} className="max-w-2xl space-y-4">
      ...
      <div>
        <label className={labelClass} htmlFor="content">
          Content (Markdown — a rich WYSIWYG editor is a planned follow-up)
        </label>
        <textarea id="content" name="content" required rows={12} defaultValue={item?.content} className={`${inputClass} font-mono`} />
      </div>
      <div>
