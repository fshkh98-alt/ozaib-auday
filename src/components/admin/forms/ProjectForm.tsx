    ...
    <form action={action} className="max-w-2xl space-y-4">
      ...
      <div>
        <label className={labelClass} htmlFor="slug">
          Slug (url-friendly, e.g. ransomware-detector)
        </label>
        <input
          id="slug"
          name="slug"
      ...
      <div>
        <label className={labelClass} htmlFor="fullDesc">
          Full description
        </label>
        <textarea
          id="fullDesc"
      ...
      <div>
        <label className={labelClass} htmlFor="content">
          Content (long-form, plain text for now)
        </label>
        <textarea
          id="content"
          name="content"
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            name="endDate"
            type="date"
            defaultValue={toInputDate(item?.endDate)}
            className={inputClass}
          />
        </div>
      </div>
