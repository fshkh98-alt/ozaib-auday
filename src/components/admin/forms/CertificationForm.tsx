...
export function CertificationForm({
  ...
  return (
    <form action={action} className="max-w-lg space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            type="date"
            required
            defaultValue={toInputDate(item?.issueDate)}
            className={inputClass}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            name="expirationDate"
            type="date"
            defaultValue={toInputDate(item?.expirationDate)}
            className={inputClass}
          />
        </div>
      </div>
      ...
      <div>
        <label className={labelClass} htmlFor="credentialId">
          Credential ID
        </label>
        <input
          id="credentialId"
      ...
      <label className="flex items-center gap-2 text-sm text-text">
        <input
          type="checkbox"
          name="showCredentialId"
          defaultChecked={item?.showCredentialId ?? true}
        />
        Show credential ID publicly
      </label>

      <div>
        <label className={labelClass} htmlFor="credentialUrl">
          Credential URL
        </label>
        <input
          id="credentialUrl"
